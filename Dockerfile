...
ARG NEXT_PUBLIC_AVERLOCK_ENV=staging
ARG NEXT_PUBLIC_AVERLOCK_INDEXER_URL

ENV NEXT_PUBLIC_BASE_SEPOLIA_RPC_URL=$NEXT_PUBLIC_BASE_SEPOLIA_RPC_URL \
    NEXT_PUBLIC_BASE_MAINNET_RPC_URL=$NEXT_PUBLIC_BASE_MAINNET_RPC_URL \
    NEXT_PUBLIC_AVERLOCK_ENV=$NEXT_PUBLIC_AVERLOCK_ENV \
